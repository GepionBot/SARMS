const Button = ({ 
  ...
  const sizes = {
    sm: 'px-2.5 py-1 sm:px-3 sm:py-1.5 text-sm',
    md: 'px-3 py-2 sm:px-4 sm:py-2 text-base',
  ...
  return (
    ...
    >
      {loading && (
        <svg className="animate-spin -ml-1 mr-1.5 h-4 w-4 sm:mr-2" fill="none" viewBox="0 0 24 24">
